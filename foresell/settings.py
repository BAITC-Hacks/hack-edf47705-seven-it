"""
Django settings for foresell project.
...
WSGI_APPLICATION = 'foresell.wsgi.application'
...
# Claude (Anthropic) settings. Without credentials Foresell falls back to rule-based recommendations.
